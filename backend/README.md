...
## Project Structure
    ...
    ├── testing_travelplann_38788  # Django project configurations
...
1. Clone this repo and `cd testing_travelplann_38788`
...
2. Clone this repo and `cd testing_travelplann_38788`
